<x-layout>
    <div class="flex flex-col justify-center items-center my-10">
        ...
        <div
            ...
            <div class="md:w-1/3 ">
                <img src="{{ $movie->img_url }}" alt="{{ $movie->title }}" class="h-auto w-full object-cover">
            </div>
            ...
            <div class="md:w-2/3 p-4 flex flex-col justify-between">
                ...
                <div class="mb-2">
                    ...
                    <div class="flex items-center mt-1 space-x-2">
                        <p class="text-md text-gray-400">({{ $movie->year_published }})</p>
                ...
                <div class="mb-2">
                    <p class="text-gray-300">{{ Str::limit($movie->description, 60) }}</p>
                </div>
